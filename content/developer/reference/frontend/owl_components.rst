...
The ColorList let you choose a color from a predefined list.
...
.. example::
   ...
   .. code-block:: xml
    ...
    <Notebook orientation="'vertical'">
      <t t-slot="page_1" title="Some Title" isVisible="true">
        <h1>My First Page</h1>
        <p>It's time to build Owl components. Did you read the documentation?</p>
      </t>
      <t t-slot="page_2" title="Some Title" isVisible="true">
